...
class findSite extends Component {
  constructor() {
    ...
    this.handleNameInput = this.handleNameInput.bind(
      this
    );
    this.onSubmit = this.onSubmit.bind(this);
    this.determineURL = this.determineURL.bind(
      this
    );
  }
  ...
  getData(name) {
    axios
      .get(`${SERVER}web/yarden`) //will be set to ${name}
      .then(res =>
        this.setState({
          pageData: res.data,
          waiting: false
